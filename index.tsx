...
const getBlogPosts = (language: Language): BlogPostItem[] => {
  const posts = {
    ja: [
      {
        title: "塀の外は自由だと思っていた。——会社員・副業・フリーランス、三つの壁を越えてわかったこと",
        url: "https://note.com/dql/n/n1fc72d1e0e29",
        thumbnail: "https://assets.st-note.com/production/uploads/images/285951580/rectangle_large_type_2_5aab1941f96cb7f332fd01b648a6198d.png",
        date: "2026.06.16",
        desc: "壁の外に出たら自由だと思ってた。でも外には、別の壁があった。フリーランスになった日の朝、私はその意味を身をもって知ることになるんだよね。"
      },
      {
        title: "AI時代の「管制塔」へ。複数AIを束ねて爆速開発する完全ガイド",
        url: "https://note.com/dql",
        thumbnail: "https://images.unsplash.com/photo-1677442136019-21780efad99a?q=80&w=600",
        date: "2026.06.08",
        desc: "AIを単なるチャットツールとしてではなく、複数のAIを束ねる「管制塔」としてのシステム設計と実践的活用法。"
      },
      {
        title: "Adobe CC、解約しなくていいです。月額9,080円を半額以下にする方法",
        url: "https://note.com/dql",
        thumbnail: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=600",
        date: "2026.06.05",
        desc: "デザイナーの必須ツールAdobe CC。月額固定費を劇的に削減するための合法的な裏ワザと、継続契約のコツ。"
      },
      {
        title: "Codexの教科書：AIに仕事を任せるための実践入門",
        url: "https://note.com/dql",
        thumbnail: "https://images.unsplash.com/photo-1542744094-3a31f103e35f?q=80&w=600",
        date: "2026.05.26",
        desc: "AIエージェントに自律的なタスクを任せるためのプロンプト設計と、ビジネスの自動化を実現する実践書。"
      }
    ],
    en: [
      {
        title: "I Thought the Outside of the Fence was Free - Career, Side Hustle, Freelance",
        url: "https://note.com/dql/n/n1fc72d1e0e29",
        thumbnail: "https://assets.st-note.com/production/uploads/images/285951580/rectangle_large_type_2_5aab1941f96cb7f332fd01b648a6198d.png",
        date: "2026.06.16",
        desc: "I thought I would be free once I got outside. But outside, there was another wall. On the morning I became a freelancer, I learned its meaning firsthand."
      },
      {
        title: "To the 'Control Tower' of the AI Era: Complete Guide to Bundled Fast Development",
        url: "https://note.com/dql",
        thumbnail: "https://images.unsplash.com/photo-1677442136019-21780efad99a?q=80&w=600",
        date: "2026.06.08",
        desc: "System design and practical usage of multiple AI agents as a central control tower, rather than simple chat tools."
      },
      {
        title: "No Need to Cancel Adobe CC: How to Cut Monthly Fees in Half",
        url: "https://note.com/dql",
        thumbnail: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=600",
        date: "2026.06.05",
        desc: "Essential tool for designers. Legal tricks to drastically reduce monthly overheads and tips on contract renewals."
      },
      {
        title: "The Codex Textbook: Practical Introduction to Delegating Tasks to AI",
        url: "https://note.com/dql",
        thumbnail: "https://images.unsplash.com/photo-1542744094-3a31f103e35f?q=80&w=600",
        date: "2026.05.26",
        desc: "Prompt engineering to delegate autonomous tasks to AI agents and implement business automation."
      }
    ],
    zh: [
      {
        title: "我曾以为围栏之外是自由的——跨越职员、副业、自由职业三道墙的感悟",
        url: "https://note.com/dql/n/n1fc72d1e0e29",
        thumbnail: "https://assets.st-note.com/production/uploads/images/285951580/rectangle_large_type_2_5aab1941f96cb7f332fd01b648a6198d.png",
        date: "2026.06.16",
        desc: "我曾以为走出这堵墙就能获得自由。但外面的世界，还有另外的墙。在成为自由职业者的那个早晨，我真切地体会到了这句话的含义。"
      },
      {
        title: "走向AI时代的「控制塔」：多AI协同快速开发完全指南",
        url: "https://note.com/dql",
        thumbnail: "https://images.unsplash.com/photo-1677442136019-21780efad99a?q=80&w=600",
        date: "2026.06.08",
        desc: "并非把AI当成简单的对话工具，而是把多个AI组合成一个「控制塔」的系统设计与实战方法。"
      },
      {
        title: "无需注销 Adobe CC：将月费降至一半以下的合法技巧",
        url: "https://note.com/dql",
        thumbnail: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=600",
        date: "2026.06.05",
        desc: "设计师的必备工具 Adobe CC。剧烈削减固定开销的合法捷径以及续约技巧。"
      },
      {
        title: "Codex的教科书：把工作交给AI的实践入门",
        url: "https://note.com/dql",
        thumbnail: "https://images.unsplash.com/photo-1542744094-3a31f103e35f?q=80&w=600",
        date: "2026.05.26",
        desc: "使AI代理能够执行自主任务的提示词设计，以及实现业务自动化的实践指南。"
      }
    ]
  };
...
const Blog = ({ language }: { language: Language }) => {
  const t = translations.blog[language];
  const posts = getBlogPosts(language);

  return (
    <section id="blog" className="py-24 bg-gray-900/20 border-t border-gray-800/50">
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-20 text-center">
          <h2 className="text-4xl md:text-6xl font-black text-white mb-6 tracking-tighter uppercase">{t.title}</h2>
          <p className="text-gray-500 text-lg">{t.subtitle}</p>
          <div className="w-24 h-1.5 bg-gradient-to-r from-red-600 to-orange-500 mx-auto rounded-full mt-6"></div>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {posts.map((post, i) => (
            <a
              ...
              className="group flex flex-col bg-gray-900/40 border border-gray-800/50 rounded-[2rem] overflow-hidden hover:border-orange-500/50 transition-all shadow-2xl h-full"
            >
              <div className="aspect-[16/9] overflow-hidden relative bg-gray-950">
                <SmartImage
                  src={post.thumbnail}
                  alt={post.title}
              ...
              <div className="p-8 flex flex-col flex-grow">
                <span className="text-[10px] text-gray-500 font-bold mb-3">{post.date}</span>
                <h3 className="text-white font-bold text-lg leading-snug mb-4 group-hover:text-orange-500 transition-colors line-clamp-2">
                  {post.title}
                </h3>
                <p className="text-gray-400 text-xs leading-relaxed mb-6 line-clamp-3 flex-grow">
                  {post.desc}
                </p>
                <div className="mt-auto pt-4 border-t border-gray-800/50 flex items-center gap-2 text-[10px] text-orange-500 font-black uppercase tracking-wider">
