...
const r2VideoLinks = {
  crimson: 'https://pub-d8812e3998414b08ae847f9120a47bd7.r2.dev/videos/%E3%82%AF%E3%83%AA%E3%83%A0%E3%82%BD%E3%82%99%E3%83%B3%E3%83%9F%E3%83%A9%E3%83%BC%E3%83%9B%E3%82%9A%E3%83%B3%E3%83%88%E3%82%99_1080p.mp4',
  wfaiaAd: 'https://pub-d8812e3998414b08ae847f9120a47bd7.r2.dev/videos/WFAIA%202026%20%E5%BA%83%E5%91%8A%E9%83%A8%E9%96%8001_LTX_2_overlay_1080p_30fps.mp4',
  wfaiaDrama: 'https://pub-d8812e3998414b08ae847f9120a47bd7.r2.dev/videos/telop_export_1787055536947.mp4',
  gainaCm: 'https://pub-d8812e3998414b08ae847f9120a47bd7.r2.dev/videos/2026%20GAINA%E9%AD%82%2015%E7%A7%92CM%E3%82%B7%E3%83%BC%E3%82%B1%E3%83%B3%E3%82%B9_voice.mp4',
  gainaInstallation: 'https://pub-d8812e3998414b08ae847f9120a47bd7.r2.dev/videos/2026%20GAINA%E9%AD%82%20%E8%A8%AD%E7%BD%AE%E4%BE%8B%E5%AE%9F%E7%89%A9809337624.529660.mp4'
} as const;
...
const additionalAIVideoData: Record<Language, AIVideoItem[]> = {
  ja: [
    ...
    { title: 'クリムゾンミラーポンド', id: 'crimson-mirror-pond', url: r2VideoLinks.crimson, videoUrl: r2VideoLinks.crimson, platform: 'local', localOnly: true, thumbnail: 'thumbnails/sousakuai-agent-cup-vol2.png', awardImage: '08_ai_video/previews/crimson-award.jpg', badge: 'SousakuAI Agent Creation Cup Vol.2', challenge: '特撮カテゴリ / AIアニメーション', date: '2026-07-22', genre: 'アクション', type: '短編アニメ', sortGenre: 'action', sortType: 'short', judgeComments: ['特撮カテゴリでアニメ映像への挑戦で評価に悩んだ作品です。アニメがダメなわけではないですが、コンテストの主旨として特撮らしい演出をもっと盛り込んで欲しかったです。', '「クリムゾンミラーポンド」というタイトルと、音楽の入りから一気に作品の世界観へ引き込まれました。登場するモンスターもとても愛らしく、作品ならではの魅力を感じました。', '物語の展開がやや唐突に感じられる場面があり、セリフの訛りや、BGM・環境音のバランスが整うことで、作品全体がさらに自然で見やすくなりそうです。'] },
    { title: 'WFAIA 2026 広告部門', id: 'wfaia-ad', url: r2VideoLinks.wfaiaAd, videoUrl: r2VideoLinks.wfaiaAd, platform: 'local', localOnly: true, thumbnail: '08_ai_video/previews/wfaia-ad.jpg', supportingImage: '08_ai_video/previews/wfaia-context.jpg', supportingImageLabel: 'WFAIA 2026 大会情報', badge: 'WFAIA 2026 / 広告部門', challenge: '2026年7月31日提出', date: '2026-07-31', genre: '広告', type: 'CM', sortGenre: 'advertising', sortType: 'cm' },
    { title: 'WFAIA 2026 ショートドラマ部門', id: 'wfaia-drama', url: r2VideoLinks.wfaiaDrama, videoUrl: r2VideoLinks.wfaiaDrama, platform: 'local', localOnly: true, thumbnail: '08_ai_video/previews/wfaia-drama.jpg', supportingImage: '08_ai_video/previews/wfaia-context.jpg', supportingImageLabel: 'WFAIA 2026 大会情報', badge: 'WFAIA 2026 / ショートドラマ部門', challenge: '2026年8月14日提出', date: '2026-08-14', genre: 'ドラマ', type: 'ショートドラマ', sortGenre: 'drama', sortType: 'short' },
    { title: '2026 GAINA魂 15秒CM', id: 'gaina-cm', url: r2VideoLinks.gainaCm, videoUrl: r2VideoLinks.gainaCm, platform: 'local', localOnly: true, thumbnail: '08_ai_video/previews/gaina-cm-user.jpg', badge: '広告 / CM', challenge: '納品版と関連映像を1作品として掲載', date: '2026-06-21', genre: '広告', type: 'CM', sortGenre: 'advertising', sortType: 'cm' },
    { title: '2026 GAINA魂 街頭ビジョン', id: 'gaina-installation', url: r2VideoLinks.gainaInstallation, videoUrl: r2VideoLinks.gainaInstallation, platform: 'local', localOnly: true, thumbnail: '08_ai_video/previews/gaina-installation.jpg', badge: '街頭ビジョン / 実写', challenge: '街頭ビジョン', date: '2026-06-21', genre: 'イベント', type: '街頭ビジョン', sortGenre: 'event', sortType: 'street-vision' },
  ...
  en: [
    ...
    { title: 'Crimson Mirror Pond', id: 'crimson-mirror-pond', url: r2VideoLinks.crimson, videoUrl: r2VideoLinks.crimson, platform: 'local', localOnly: true, thumbnail: 'thumbnails/sousakuai-agent-cup-vol2.png', awardImage: '08_ai_video/previews/crimson-award.jpg', badge: 'SousakuAI Agent Creation Cup Vol.2', challenge: 'Special Effects Category / AI Animation', date: '2026-07-22', genre: 'Action', type: 'Short Animation', sortGenre: 'action', sortType: 'short', judgeComments: ['This was a challenging entry in the special-effects category, and we struggled with how to evaluate its animated approach. Animation is not a problem, but we wanted to see more special-effects-style direction for the contest theme.', 'The title and the opening music pulled us straight into the world of Crimson Mirror Pond. The monsters were charming and gave the work a distinctive appeal.', 'Some story turns felt abrupt. Smoother dialogue, BGM, and ambience would make the work even easier to follow.'] },
    { title: 'WFAIA 2026 Advertising Category', id: 'wfaia-ad', url: r2VideoLinks.wfaiaAd, videoUrl: r2VideoLinks.wfaiaAd, platform: 'local', localOnly: true, thumbnail: '08_ai_video/previews/wfaia-ad.jpg', supportingImage: '08_ai_video/previews/wfaia-context.jpg', supportingImageLabel: 'WFAIA 2026 event information', badge: 'WFAIA 2026 / Advertising', challenge: 'Submitted July 31, 2026', date: '2026-07-31', genre: 'Advertising', type: 'Commercial', sortGenre: 'advertising', sortType: 'cm' },
    { title: 'WFAIA 2026 Short Drama Category', id: 'wfaia-drama', url: r2VideoLinks.wfaiaDrama, videoUrl: r2VideoLinks.wfaiaDrama, platform: 'local', localOnly: true, thumbnail: '08_ai_video/previews/wfaia-drama.jpg', supportingImage: '08_ai_video/previews/wfaia-context.jpg', supportingImageLabel: 'WFAIA 2026 event information', badge: 'WFAIA 2026 / Short Drama', challenge: 'Submitted August 14, 2026', date: '2026-08-14', genre: 'Drama', type: 'Short Drama', sortGenre: 'drama', sortType: 'short' },
    { title: '2026 GAINA Soul 15s Commercial', id: 'gaina-cm', url: r2VideoLinks.gainaCm, videoUrl: r2VideoLinks.gainaCm, platform: 'local', localOnly: true, thumbnail: '08_ai_video/previews/gaina-cm-user.jpg', badge: 'Advertising / Commercial', challenge: 'Two related delivery videos represented as one work', date: '2026-06-21', genre: 'Advertising', type: 'Commercial', sortGenre: 'advertising', sortType: 'cm' },
    { title: '2026 GAINA Soul Street Vision', id: 'gaina-installation', url: r2VideoLinks.gainaInstallation, videoUrl: r2VideoLinks.gainaInstallation, platform: 'local', localOnly: true, thumbnail: '08_ai_video/previews/gaina-installation.jpg', badge: 'Street Vision / Live Action', challenge: 'GAINA Soul venue street vision', date: '2026-06-21', genre: 'Event', type: 'Street Vision', sortGenre: 'event', sortType: 'street-vision' },
  ...
  zh: [
    ...
    { title: '绯红镜池', id: 'crimson-mirror-pond', url: r2VideoLinks.crimson, videoUrl: r2VideoLinks.crimson, platform: 'local', localOnly: true, thumbnail: 'thumbnails/sousakuai-agent-cup-vol2.png', awardImage: '08_ai_video/previews/crimson-award.jpg', badge: 'SousakuAI Agent Creation Cup Vol.2', challenge: '特摄类别 / AI动画', date: '2026-07-22', genre: '动作', type: '短篇动画', sortGenre: 'action', sortType: 'short', judgeComments: ['这是一部在特摄类别中挑战动画表现的作品，我们在评价上曾感到犹豫。动画本身并不是问题，但如果更加入特摄风格的演出，会更贴合比赛主题。', '作品标题与音乐一开始就把观众带入了绯红镜池的世界。登场怪物非常可爱，也形成了作品独有的魅力。', '部分故事展开略显突然。如果对白、BGM与环境音的平衡更顺畅，作品会更易观看。'] },
    { title: 'WFAIA 2026 广告类别', id: 'wfaia-ad', url: r2VideoLinks.wfaiaAd, videoUrl: r2VideoLinks.wfaiaAd, platform: 'local', localOnly: true, thumbnail: '08_ai_video/previews/wfaia-ad.jpg', supportingImage: '08_ai_video/previews/wfaia-context.jpg', supportingImageLabel: 'WFAIA 2026 大赛信息', badge: 'WFAIA 2026 / 广告', challenge: '2026年7月31日提交', date: '2026-07-31', genre: '广告', type: 'CM', sortGenre: 'advertising', sortType: 'cm' },
    { title: 'WFAIA 2026 短剧类别', id: 'wfaia-drama', url: r2VideoLinks.wfaiaDrama, videoUrl: r2VideoLinks.wfaiaDrama, platform: 'local', localOnly: true, thumbnail: '08_ai_video/previews/wfaia-drama.jpg', supportingImage: '08_ai_video/previews/wfaia-context.jpg', supportingImageLabel: 'WFAIA 2026 大赛信息', badge: 'WFAIA 2026 / 短剧', challenge: '2026年8月14日提交', date: '2026-08-14', genre: '剧情', type: '短剧', sortGenre: 'drama', sortType: 'short' },
    { title: '2026 GAINA魂 15秒CM', id: 'gaina-cm', url: r2VideoLinks.gainaCm, videoUrl: r2VideoLinks.gainaCm, platform: 'local', localOnly: true, thumbnail: '08_ai_video/previews/gaina-cm-user.jpg', badge: '广告 / CM', challenge: '两份相关交付视频作为一件作品展示', date: '2026-06-21', genre: '广告', type: 'CM', sortGenre: 'advertising', sortType: 'cm' },
    { title: '2026 GAINA魂 街头大屏', id: 'gaina-installation', url: r2VideoLinks.gainaInstallation, videoUrl: r2VideoLinks.gainaInstallation, platform: 'local', localOnly: true, thumbnail: '08_ai_video/previews/gaina-installation.jpg', badge: '街头大屏 / 实拍', challenge: 'GAINA魂会场街头大屏', date: '2026-06-21', genre: '活动', type: '街头大屏', sortGenre: 'event', sortType: 'street-vision' },
...
const getAIVideoData = (language: Language): AIVideoItem[] => {
  ...
  const videoData = {
    ja: [
      ...
      { title: "ルーター攻撃", url: "https://x.com/ARrow25989974/status/1960726834204827922/video/1", thumbnail: "thumbnails/1945170933490106776.jpg" },
      { title: "みちぽっぽ", url: "https://x.com/ARrow25989974/status/1945170933490106776/video/1", thumbnail: "thumbnails/1960726834204827922.jpg" },
      ...
      { title: "AI副業での挫折を乗り越え、成功へ導く方法", url: "https://x.com/i/status/1788592514691420539", thumbnail: "thumbnails/no08.png" },
    ...
    en: [
      ...
      { title: "Router Attack", url: "https://x.com/ARrow25989974/status/1960726834204827922/video/1", thumbnail: "thumbnails/1945170933490106776.jpg" },
      { title: "Michipoppo", url: "https://x.com/ARrow25989974/status/1945170933490106776/video/1", thumbnail: "thumbnails/1960726834204827922.jpg" },
    ...
    zh: [
      ...
      { title: "路由器攻击", url: "https://x.com/ARrow25989974/status/1960726834204827922/video/1", thumbnail: "thumbnails/1945170933490106776.jpg" },
      { title: "Michipoppo", url: "https://x.com/ARrow25989974/status/1945170933490106776/video/1", thumbnail: "thumbnails/1960726834204827922.jpg" },
