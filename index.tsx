...
const additionalAIVideoData: Record<Language, AIVideoItem[]> = {
  ja: [
    ...
    { title: '2026 GAINA魂 街頭ビジョン', id: 'gaina-installation', url: driveVideoLinks.gainaInstallation.url, drivePreviewUrl: driveVideoLinks.gainaInstallation.preview, platform: 'local', localOnly: true, thumbnail: '08_ai_video/previews/gaina-installation.jpg', badge: '街頭ビジョン / 実写', challenge: '街頭ビジョン', date: '2026-06-21', genre: 'イベント', type: '街頭ビジョン', sortGenre: 'event', sortType: 'street-vision' },
  ...
  zh: [
    ...
    { title: '2026 GAINA魂 街头大屏', id: 'gaina-installation', url: driveVideoLinks.gainaInstallation.url, drivePreviewUrl: driveVideoLinks.gainaInstallation.preview, platform: 'local', localOnly: true, thumbnail: '08_ai_video/previews/gaina-installation.jpg', badge: '街头大屏 / 实拍', challenge: 'GAINA魂会场街头大屏', date: '2026-06-21', genre: '活动', type: '街头大屏', sortGenre: 'event', sortType: 'street-vision' },
